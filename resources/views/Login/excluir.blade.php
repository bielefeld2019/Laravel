...
<legend><h1><center>Excluir : {{$user->nome}}</center></h1></legend>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id= "btn_excluir" class="btn btn-danger" > Excluir o usuário: {{$user->name}} </button>
    <a id= "btn_voltar" class="btn btn-warning" href="{{url('/users')}}" > Voltar </a>
  </div>
</div>
